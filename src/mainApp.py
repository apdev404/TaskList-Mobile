...
class TaskApp(App):
    ...
    def create_inicio_content(self):
        ...
        welcome_label = BackgroundLabel(background_image='assets/fondosup.png', text="Hola \n¡Bienvenido a tu lista de tareas!", font_size=20)
        ...
        self.task_input = TextInput(size_hint=(0.7, 0.8), hint_text="Ingrese una nueva tarea",
                                    background_normal='assets/fondinput.png', border=(5, 5, 5, 5))
        input_button_layout.add_widget(self.task_input)

        # Botón para agregar tareas
        add_button = Button(size_hint=(0.15, 1), background_normal='assets/add2.png', border=(5, 5, 5, 5))
...
#FUNCION DE AÑADIR TAREA 
    def add_task(self, instance):
        ...
        if task_text:
            task_label = BackgroundLabel(
                ...
                font_size=16,
                color=(0, 0, 0, 1),
                background_image='assets/bordelist.png'
            )
            ...
            delete_button = Button(
                background_normal='assets/eliminar.png',
                size_hint=(None, None),
                size=(60, 60),
            ...
            complete_button = Button(
                background_normal='assets/completar.png',
                size_hint=(None, None),
                size=(60, 60),
                pos_hint={'center_x': 0.5, 'center_y': 0.5}
            )
    ...
    def complete_task(self, instance):
        ...
        task_label.background_image = "assets/completar.png"
        instance.disabled = True

        # Cambiar la imagen del botón a una nueva imagen
        instance.background_disabled_normal = 'assets/completed.png'
    ...
    def create_nav_bar(self):
        ...
        self.button_inicio = Button( background_normal='assets/inicio.png')
        self.button_inicio.bind(on_press=self.show_inicio)

        self.button_historial = Button(background_normal='assets/historial.png')
        self.button_historial.bind(on_press=self.show_historial)

        self.button_productividad = Button(background_normal='assets/productividad.png')
    ...
    def create_historial_content(self):
        ...
        # Barra superior de bienvenida
        welcome_bar = BoxLayout(orientation='horizontal', size_hint=(1, 0.4))
        welcome_label = BackgroundLabel(background_image='assets/fondosup.png', text="HISTORIAL", font_size=20)
        welcome_bar.add_widget(welcome_label)
...
#PANTALLA DE PRODUCTIVIDAD
    def create_productividad_content(self):
        ...
        welcome_label = BackgroundLabel(background_image='assets/fondosup.png', text="PRODUCTIVIDAD", font_size=20)
        welcome_bar.add_widget(welcome_label)
        layout.add_widget(welcome_bar)
        ...
        rojo = BackgroundLabel(background_image='assets/indicadorrojo.png', size_hint=(None, None), size=(30, 30))  # Hacer más pequeño
        ...
        verde = BackgroundLabel(background_image='assets/indicadorverde.png', size_hint=(None, None), size=(30, 30))  # Hacer más pequeño
